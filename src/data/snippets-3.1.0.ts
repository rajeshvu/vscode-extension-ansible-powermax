...
export const snippets_3_1_0: SnippetItem[] = [
    ...
    },
    {
        ...
        "description": "- dellemc.powermax.volume",
        "body": "\n- name: Move volume between storage group when current storage group is part of masking\n    view\n  dellemc.powermax.volume:\n    unispherehost: '{{ unispherehost }}'\n    universion: '{{ universion }}'\n    verifycert: '{{ verifycert }}'\n    user: '{{ user }}'\n    password: '{{ password }}'\n    serial_no: '{{ serial_no }}'\n    vol_name: '{{ vol_name }}'\n    sg_name: '{{ sg_name }}'\n    new_sg_name: '{{ new_sg_name }}'\n    state: present\n"
    },
    {
        "label": "Move volume between storage group when current storage group is not part of masking view",
        "description": "- dellemc.powermax.volume",
        "body": "\n- name: Move volume between storage group when current storage group is not part of\n    masking view\n  dellemc.powermax.volume:\n    unispherehost: '{{ unispherehost }}'\n    universion: '{{ universion }}'\n    verifycert: '{{ verifycert }}'\n    user: '{{ user }}'\n    password: '{{ password }}'\n    serial_no: '{{ serial_no }}'\n    vol_name: '{{ vol_name }}'\n    sg_name: '{{ new_sg_name }}'\n    new_sg_name: '{{ sg_name }}'\n    state: present\n"
    },
    {
        "label": "Rename volume",
        "description": "- dellemc.powermax.volume",
